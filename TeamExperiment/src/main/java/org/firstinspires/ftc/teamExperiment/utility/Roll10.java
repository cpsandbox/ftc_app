 ...
 */
@TeleOp(name="Roll 10")
public class Roll10 extends BaseLinearOp{
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        setMotorTarget(TICS_PER_REV*10, getDriveMotors());
        ...
        while(opModeIsActive() && someMotorsAreBusy(getDriveMotors())){
            idle();
            telemetry.addData("running position", Arrays.toString(getMotorPositions(getDriveMotors())));
            telemetry.update();
        }
        ...
        while(opModeIsActive()){
            idle();
            telemetry.addData("ended position", Arrays.toString(getMotorPositions(getDriveMotors())));
            telemetry.update();
        }
